 ...
 */
sha.rstr_hmac_sha1 = function(key, data) {"use strict";
	var bkey = sha.rstr2binb(key), ipad, hash, i;
	if (bkey.length > 16) {
	...
	hash = sha.binb_sha1(ipad.concat(sha.rstr2binb(data)), 512 + data.length * 8);
...
sha.rstr2hex = function(input) {"use strict";
	var hex_tab = (sha.hexcase ? "0123456789ABCDEF" : "0123456789abcdef"), output = "", x, i;
 ...
 */
sha.rstr2b64 = function(input) {"use strict";
 ...
 */
sha.rstr2any = function(input, encoding) {"use strict";
 ...
 */
sha.str2rstr_utf8 = function(input) {"use strict";
	var output = "";
	var i = -1;
	var x, y;
 ...
 */
sha.str2rstr_utf16le = function(input) {"use strict";
	var output = "", i;
 ...
 */
sha.rstr2binb = function(input) {"use strict";
 ...
 */
sha.binb2rstr = function(input) {"use strict";
	var output = "", i;
 ...
 */
sha.binb_sha1 = function(x, len) {"use strict";
	/* append padding */
 ...
 * iteration
 */
sha.sha1_ft = function(t, b, c, d) {"use strict";
	if (t < 20)
		return (b & c) | ((~b) & d);
	if (t < 40)
		return b ^ c ^ d;
...
sha.sha1_kt = function(t) {"use strict";
 ...
 */
sha.safe_add = function(x, y) {"use strict";
 ...
 */
sha.bit_rol = function(num, cnt) {"use strict";
